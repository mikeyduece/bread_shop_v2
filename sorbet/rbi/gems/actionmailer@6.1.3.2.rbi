...
module ActionMailer::Base::HelperMethods
  ...
  # source://actionpack/6.1.3.2/lib/abstract_controller/caching/fragments.rb#31
  def combined_fragment_cache_key(*args, **_arg1, &block); end

  # source://actionpack/6.1.3.2/lib/abstract_controller/caching.rb#43
...
class ActionMailer::DeliveryJob < ::ActiveJob::Base
  ...
  class << self
    ...
    # source://activejob/6.1.3.2/lib/active_job/queue_name.rb#56
    def queue_name; end
