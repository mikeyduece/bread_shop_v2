...
class Rails::Application < ::Rails::Engine
  # source://railties/6.1.3.2/lib/rails/application.rb#128
  ...
  # source://railties/6.1.3.2/lib/rails/engine.rb#520
  def build_middleware_stack; end

  # source://railties/6.1.3.2/lib/rails/application.rb#395
  def config; end

  # source://railties/6.1.3.2/lib/rails/application.rb#399
  def config=(_arg0); end

  # source://railties/6.1.3.2/lib/rails/application.rb#241
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/6.1.3.2/lib/rails/application.rb#315
  def console(&blk); end

  # source://railties/6.1.3.2/lib/rails/application.rb#443
  def credentials; end

  # source://railties/6.1.3.2/lib/rails/application.rb#415
  def credentials=(_arg0); end

  # source://railties/6.1.3.2/lib/rails/application.rb#123
  def default_url_options(*_arg0, **_arg1, &_arg2); end

  # source://railties/6.1.3.2/lib/rails/application.rb#123
  def default_url_options=(arg); end

  # source://railties/6.1.3.2/lib/rails/application.rb#508
  def eager_load!; end

  # source://railties/6.1.3.2/lib/rails/application.rb#474
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/6.1.3.2/lib/rails/application.rb#261
  def env_config; end

  # source://railties/6.1.3.2/lib/rails/application.rb#121
  def executor; end

  # source://railties/6.1.3.2/lib/rails/application.rb#321
  def generators(&blk); end

  # source://railties/6.1.3.2/lib/rails/application.rb#487
  def helpers_paths; end

  # source://railties/6.1.3.2/lib/rails/application.rb#382
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/6.1.3.2/lib/rails/application.rb#149
  def initialized?; end

  # source://railties/6.1.3.2/lib/rails/application.rb#303
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/6.1.3.2/lib/rails/application.rb#389
  def initializers; end

  # source://railties/6.1.3.2/lib/rails/application.rb#332
  def isolate_namespace(mod); end

  # source://railties/6.1.3.2/lib/rails/application.rb#173
  def key_generator; end

  # source://railties/6.1.3.2/lib/rails/application.rb#199
  def message_verifier(verifier_name); end

  # source://railties/6.1.3.2/lib/rails/application.rb#503
  ...
  # source://railties/6.1.3.2/lib/rails/application.rb#296
  def rake_tasks(&block); end

  # source://railties/6.1.3.2/lib/rails/application.rb#168
  ...
  # source://railties/6.1.3.2/lib/rails/application.rb#358
  def require_environment!; end

  # source://railties/6.1.3.2/lib/rails/application.rb#363
  def routes_reloader; end

  # source://railties/6.1.3.2/lib/rails/application.rb#153
  def run_load_hooks!; end

  # source://railties/6.1.3.2/lib/rails/application.rb#309
  def runner(&blk); end

  # source://railties/6.1.3.2/lib/rails/application.rb#119
  def sandbox; end
  ...
  # source://railties/6.1.3.2/lib/rails/application.rb#426
  def secret_key_base; end

  # source://railties/6.1.3.2/lib/rails/application.rb#401
  def secrets; end

  # source://railties/6.1.3.2/lib/rails/application.rb#415
  def secrets=(_arg0); end

  # source://railties/6.1.3.2/lib/rails/application.rb#327
  def server(&blk); end

  # source://railties/6.1.3.2/lib/rails/application.rb#483
  def to_app; end

  # source://railties/6.1.3.2/lib/rails/application.rb#370
  def watchable_args; end

  protected

  # source://railties/6.1.3.2/lib/rails/application.rb#585
  def default_middleware_stack; end

  # source://railties/6.1.3.2/lib/rails/application.rb#551
  def ordered_railties; end

  # source://railties/6.1.3.2/lib/rails/application.rb#573
  def railties_initializers(current); end

  # source://railties/6.1.3.2/lib/rails/application.rb#540
  def run_console_blocks(app); end

  # source://railties/6.1.3.2/lib/rails/application.rb#530
  def run_generators_blocks(app); end

  # source://railties/6.1.3.2/lib/rails/application.rb#535
  def run_runner_blocks(app); end

  # source://railties/6.1.3.2/lib/rails/application.rb#545
  def run_server_blocks(app); end

  # source://railties/6.1.3.2/lib/rails/application.rb#519
  def run_tasks_blocks(app); end

  # source://railties/6.1.3.2/lib/rails/application.rb#590
  def validate_secret_key_base(secret_key_base); end

  private

  # source://railties/6.1.3.2/lib/rails/application.rb#624
  def build_middleware; end

  # source://railties/6.1.3.2/lib/rails/application.rb#617
  def build_request(env); end

  # source://railties/6.1.3.2/lib/rails/application.rb#628
  def coerce_same_site_protection(protection); end

  # source://railties/6.1.3.2/lib/rails/application.rb#601
  def generate_development_secret; end

  class << self
    # source://railties/6.1.3.2/lib/rails/application.rb#351
    def add_lib_to_load_path!(root); end

    # source://railties/6.1.3.2/lib/rails/application.rb#103
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/6.1.3.2/lib/rails/application.rb#107
    def find_root(from); end

    # source://railties/6.1.3.2/lib/rails/application.rb#92
    def inherited(base); end

    # source://railties/6.1.3.2/lib/rails/application.rb#99
    def instance; end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#29
  def initialize(*_arg0); end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#14
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#335
  def annotations; end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#27
  def api_only; end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#219
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#355
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#295
  def colorize_logging; end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#299
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#339
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#270
  def database_configuration; end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#226
  def debug_exception_response_format; end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#230
  def debug_exception_response_format=(_arg0); end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#367
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#211
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#255
  def load_database_yaml; end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#81
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#232
  def paths; end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#347
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#304
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#331
  ...
  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#416
  def credentials_available_for_current_env?; end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#400
  def default_credentials_content_path; end

  # source://railties/6.1.3.2/lib/rails/application/configuration.rb#408
  def default_credentials_key_path; end
end

# source://sprockets-rails//lib/sprockets/railtie.rb#57
class Rails::Engine < ::Rails::Railtie
  # source://railties/6.1.3.2/lib/rails/engine.rb#432
  def initialize; end
  ...
  # source://activesupport/6.1.3.2/lib/active_support/callbacks.rb#835
  def _load_seed_callbacks; end

  # source://activesupport/6.1.3.2/lib/active_support/callbacks.rb#823
  def _run_load_seed_callbacks(&block); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#520
  def app; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#537
  def call(env); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#556
  def config; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#484
  def eager_load!; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#532
  def endpoint; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#430
  def engine_name(*_arg0, **_arg1, &_arg2); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#543
  def env_config; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#503
  def helpers; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#515
  def helpers_paths; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#430
  def isolated?(*_arg0, **_arg1, &_arg2); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#446
  def load_console(app = T.unsafe(nil)); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#470
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#455
  def load_runner(app = T.unsafe(nil)); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#564
  def load_seed; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#479
  def load_server(app = T.unsafe(nil)); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#462
  def load_tasks(app = T.unsafe(nil)); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#429
  def middleware(*_arg0, **_arg1, &_arg2); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#429
  def paths(*_arg0, **_arg1, &_arg2); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#498
  def railties; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#429
  def root(*_arg0, **_arg1, &_arg2); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#549
  def routes(&block); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#668
  def routes?; end

  protected

  # source://railties/6.1.3.2/lib/rails/engine.rb#673
  def run_tasks_blocks(*_arg0); end

  private

  # source://railties/6.1.3.2/lib/rails/engine.rb#705
  def _all_autoload_once_paths; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#709
  def _all_autoload_paths; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#713
  def _all_load_paths(add_autoload_paths_to_load_path); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#729
  def build_middleware; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#721
  def build_request(env); end

  # source://railties/6.1.3.2/lib/rails/engine.rb#701
  def default_middleware_stack; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#685
  def has_migrations?; end

  # source://railties/6.1.3.2/lib/rails/engine.rb#679
  ...
  class << self
    ...
    # source://activesupport/6.1.3.2/lib/active_support/callbacks.rb#827
    def _load_seed_callbacks; end

    # source://activesupport/6.1.3.2/lib/active_support/callbacks.rb#831
    def _load_seed_callbacks=(value); end

    # source://railties/6.1.3.2/lib/rails/engine.rb#353
    def called_from; end

    # source://railties/6.1.3.2/lib/rails/engine.rb#353
    def called_from=(_arg0); end

    # source://railties/6.1.3.2/lib/rails/engine.rb#358
    def eager_load!(*_arg0, **_arg1, &_arg2); end

    # source://railties/6.1.3.2/lib/rails/engine.rb#378
    def endpoint(endpoint = T.unsafe(nil)); end

    # source://railties/6.1.3.2/lib/rails/railtie.rb#176
    def engine_name(name = T.unsafe(nil)); end

    # source://railties/6.1.3.2/lib/rails/engine.rb#416
    def find(path); end

    # source://railties/6.1.3.2/lib/rails/engine.rb#374
    def find_root(from); end

    # source://railties/6.1.3.2/lib/rails/engine.rb#689
    def find_root_with_flag(flag, root_path, default = T.unsafe(nil)); end

    # source://railties/6.1.3.2/lib/rails/engine.rb#360
    def inherited(base); end

    # source://railties/6.1.3.2/lib/rails/engine.rb#384
    def isolate_namespace(mod); end
