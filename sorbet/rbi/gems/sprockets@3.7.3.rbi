...
# source://sprockets//lib/sprockets/autoload/sass.rb#5
...
#
# source://sprockets//lib/sprockets/sass_cache_store.rb#28
class Sprockets::SassCacheStore < ::Sprockets::SassProcessor::CacheStore
  # @return [SassCacheStore] a new instance of SassCacheStore
  #
...
#
# source://sprockets//lib/sprockets/sass_cache_store.rb#6
class Sprockets::SassProcessor::CacheStore < ::Sass::CacheStores::Base
  # @return [CacheStore] a new instance of CacheStore
  #
  # source://sprockets//lib/sprockets/sass_cache_store.rb#9
  def initialize(cache, version); end

  # source://sprockets//lib/sprockets/sass_cache_store.rb#17
  def _retrieve(key, version, sha); end

  # source://sprockets//lib/sprockets/sass_cache_store.rb#13
  def _store(key, version, sha, contents); end

  # source://sprockets//lib/sprockets/sass_cache_store.rb#21
  def path_to(key); end
end
...
module Sprockets::SassProcessor::Functions
  ...
  #
  # source://sass-rails/5.1.0/lib/sass/rails/helpers.rb#7
