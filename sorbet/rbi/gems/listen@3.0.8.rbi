...
module Listen
  class << self
    ...
    #
    # source://listen//lib/listen.rb#43
    def stop; end
    ...
    #
    # source://listen//lib/listen.rb#34
...
module Listen::Adapter
  class << self
    # source://listen//lib/listen/adapter.rb#39
    def _log(type, message); end

    # source://listen//lib/listen/adapter.rb#30
    def _usable_adapter_class; end

    # source://listen//lib/listen/adapter.rb#34
    def _warn_polling_fallback(options); end

    # source://listen//lib/listen/adapter.rb#14
...
class Listen::Adapter::Base
  ...
  class << self
    # source://listen//lib/listen/adapter/base.rb#132
    def _log(*args, &block); end
...
class Listen::Adapter::Darwin < ::Listen::Adapter::Base
  ...
  #
  # source://listen//lib/listen/adapter/darwin.rb#36
  def _configure(dir, &callback); end

  # source://listen//lib/listen/adapter/darwin.rb#55
  def _process_event(dir, event); end

  # source://listen//lib/listen/adapter/darwin.rb#46
  def _run; end

  # source://listen//lib/listen/adapter/darwin.rb#66
  def _run_worker(worker); end

  # source://listen//lib/listen/adapter/darwin.rb#73
  def _run_workers_in_background(workers); end

  # source://listen//lib/listen/adapter/darwin.rb#81
...
class Listen::Adapter::Linux < ::Listen::Adapter::Base
  ...
  # source://listen//lib/listen/adapter/linux.rb#88
  def _change(event_flags); end
  ...
  # @return [Boolean]
  #
  # source://listen//lib/listen/adapter/linux.rb#99
  ...
  # @return [Boolean]
  #
  # source://listen//lib/listen/adapter/linux.rb#78
  def _skip_event?(event); end

  # source://listen//lib/listen/adapter/linux.rb#103
  def _stop; end
end
...
class Listen::Adapter::Windows < ::Listen::Adapter::Base
  ...
  # source://listen//lib/listen/adapter/windows.rb#89
...
class Listen::Backend
  ...
  #
  # source://listen//lib/listen/backend.rb#11
  def initialize(directories, queue, silencer, config); end

  # source://listen//lib/listen/backend.rb#35
  def min_delay_between_events; end

  # source://listen//lib/listen/backend.rb#27
  def start; end
  ...
  #
  # source://listen//lib/listen/backend.rb#41
  def adapter; end
end
...
class Listen::Event::Config
  ...
  # source://listen//lib/listen/event/config.rb#38
  def optimize_changes(changes); end

  # @return [Boolean]
  #
  # source://listen//lib/listen/event/config.rb#50
  def paused?; end
  ...
  #
  # source://listen//lib/listen/event/config.rb#56
  def listener; end
end
...
class Listen::Event::Queue
  ...
  #
  # source://listen//lib/listen/event/queue.rb#18
  def initialize(config, &block); end

  # source://listen//lib/listen/event/queue.rb#24
  def <<(args); end

  # @return [Boolean]
  #
  # source://listen//lib/listen/event/queue.rb#36
  def empty?; end
  ...
  # source://listen//lib/listen/event/queue.rb#50
  ...
  # Returns the value of attribute config.
  #
  # source://listen//lib/listen/event/queue.rb#48
  def config; end
...
# source://listen//lib/listen/event/queue.rb#8
...
class Listen::FSM::State
  ...
  # source://listen//lib/listen/fsm.rb#119
  def call(obj); end
...
class Listen::Listener
  ...
  # @yieldparam removed [Array<String>] the list of removed files
  #
  # source://listen//lib/listen/listener.rb#34
  def initialize(*dirs, &block); end

  # source://listen//lib/listen/listener.rb#115
  def ignore(regexps); end

  # source://listen//lib/listen/listener.rb#119
  def ignore!(regexps); end

  # source://listen//lib/listen/listener.rb#123
  ...
  # @return [Boolean]
  #
  # source://listen//lib/listen/listener.rb#111
  def paused?; end
  ...
  #
  # source://listen//lib/listen/listener.rb#97
  def stop; end
  ...
  #
  # source://listen//lib/listen/listener.rb#129
  def processor; end
end
...
class Listen::Listener::Config
  ...
  # source://listen//lib/listen/listener/config.rb#34
  def adapter_instance_options(klass); end

  # source://listen//lib/listen/listener/config.rb#39
...
class Listen::Record
  ...
  # source://listen//lib/listen/record.rb#81
...
class Listen::Record::Entry
  ...
  # source://listen//lib/listen/record/entry.rb#21
  def meta; end

  # Returns the value of attribute name.
  #
  # source://listen//lib/listen/record/entry.rb#12
  def name; end

  # source://listen//lib/listen/record/entry.rb#39
  def real_path; end
  ...
  #
  # source://listen//lib/listen/record/entry.rb#30
  ...
  # @raise [Errno::ENOTDIR]
  #
  # source://listen//lib/listen/record/entry.rb#50
  def _entries(dir); end

  # source://listen//lib/listen/record/entry.rb#45
  def _join; end
end
