...
module Api
  module RecipeHelper
    def create_recipe(user:, params:)
      ...
      create_recipe_ingredients(recipe:, ingredients: params[:ingredients])
    ...
    def update_recipe(params:)
      ...
      update_attributes(number_of_portions: params[:number_of_portions],
                        weight_per_portion: params[:weight_per_portion], units: params[:units])
    ...
    def recalculated_amounts(new_flour_weight:)
      recipe_ingredients.includes(:ingredient).find_each do |recipe_ingredient|
        ...
        (new_flour_weight * (recipe_ingredient.bakers_percentage.to_f / 100)).round(2)
      end
    end
  end
end
